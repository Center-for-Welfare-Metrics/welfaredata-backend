...
router.get("/:_id", AuthProtected, Controller.get_one_by_id);

router.post("", AuthProtected, ProcessogramController.create);

router.patch("/:_id/newmedia", ProcessogramController.addMedia);
...
router.patch("/:_id", AuthProtected, ProcessogramController.update);
